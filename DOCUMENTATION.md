...
- Standalone Application (not available yet):
...
- Source Code: Ensure Python 3.11 (or above) is installed on your machine. Clone the repository and install all necessary dependencies by opening a terminal in the project directory and running pip install -r requirements.txt.
